    <head>
        <meta charset="utf-8" />
        <link rel="apple-touch-icon" sizes="76x76" href="{{asset('adminassets/img/favicon.png')}}">
        <link rel="icon" type="image/png" href="{{asset('favicon.png')}}">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
        <title>Flex Health</title>
        <meta content='width=device-width, initial-scale=1.0, shrink-to-fit=no' name='viewport' />
        <!--     Fonts and icons     -->
        <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700|Roboto+Slab:400,700|Material+Icons" />
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css">
        <!-- CSS Files -->
        <link href="{{asset('adminassets/css/material-dashboard.min.css')}}" rel="stylesheet" />
        <!-- CSS Just for demo purpose, don't include it in your project -->
        <link href="{{asset('adminassets/demo/demo.css')}}" rel="stylesheet" />
        <link href="{{asset('adminassets/css/intlTelInput.css')}}" rel="stylesheet" />
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.6/cropper.css" integrity="sha256-jKV9n9bkk/CTP8zbtEtnKaKf+ehRovOYeKoyfthwbC8=" crossorigin="anonymous" />

        <link href="{{asset('adminassets/demo/adminstyle.css')}}" rel="stylesheet" />
        ...
        <script src="{{asset('adminassets/js/plugins/sweetalert2.js')}}"></script>
        ...
        <script src="{{asset('adminassets/js/plugins/fullcalendar.min.js')}}"></script>
        ...
        <script src="{{asset('adminassets/js/plugins/arrive.min.js')}}"></script>
        <!-- Chartist JS -->
        ...
        <script src="{{asset('adminassets/js/material-dashboard.min.js')}}" type="text/javascript"></script>
        <script src="{{asset('adminassets/js/intlTelInput.js')}}" type="text/javascript"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.6/cropper.js" integrity="sha256-CgvH7sz3tHhkiVKh05kSUgG97YtzYNnWt6OXcmYzqHY=" crossorigin="anonymous"></script>
        <!-- Material Dashboard DEMO methods, don't include it in your project! -->
        <script src="{{asset('adminassets/demo/demo.js')}}"></script>
        <script src="https://cdn.tiny.cloud/1/srbjpmfngyoo3i8sa2pl3tohfm3ep2gyu5nl7pks3h3jzje5/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
        <script>
